...
<body class="bg-gradient-success">
    ...
    <div class="modal fade" id="myModal" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="h4 text-gray-900">LOGIN ACCOUNT BASED ON</h1>
                </div>
                <div class="modal-body">
                    <a href="Authentication/Login/loginLecture.php" class="btn btn-warning btn-user btn-block">
                        LOGIN AS LECTURE
                    </a>             
                    <a href="Authentication/Login/loginStudent.php" class="btn btn-danger btn-user btn-block">
                        LOGIN AS STUDENT
                    </a>
                </div>
                <div class="modal-footer">
                    <a href="Authentication/Register/register.php" class="btn btn-secondary">Register</a>
                </div>
            </div>
        </div>
    </div>
