<?php
    ...
    require '../../function.php';
        ...
        if(isset($_COOKIE["nrp"]) && isset($_COOKIE["key"])) {
            $nrp = $_COOKIE["nrp"];
            $key = $_COOKIE["key"];
            
            $result = mysqli_query($connect, "SELECT email FROM students WHERE nrp = '$nrp'");
        ...
        if(isset($_POST["login"])) {
            ...
            $result = mysqli_query($connect, "SELECT * FROM students WHERE email = '$email'");
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Login Account As Student</h1>
                                    </div>
